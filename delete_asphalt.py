...
class RANSAC:
    ...
    def filter_asphalt(points: List[LidarPoint]) -> List[LidarPoint]:
        ...
        distance_threshold = 0.015 #   максимальное расстояние до плоскости для inliers (в метрах)
        min_plane_points = 300 #   минимальное количество точек для признания плоскости валидной 
        ...
        return points  # Если плоскость не найдена, вернуть исходные точки
